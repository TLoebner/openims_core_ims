...
<center>
	<table class="as" width="500">
		<logic:notEmpty name="resultList">
			...
			<logic:iterate name="resultList" id="visited_network"
				type="de.fhg.fokus.hss.db.model.VisitedNetwork" indexId="ix">
				<tr class="<%= ix.intValue()%2 == 0 ? "even" : "odd" %>">
					<td>
						<bean:write name="visited_network" property="id" />
					</td>
					<td> 
						<a href="/hss.web.console/VN_Load.do?id=<bean:write name="visited_network" property="id" />"> 
							<bean:write name="visited_network" property="identity" />
						</a>	
					</td>
				</tr>
			</logic:iterate>
