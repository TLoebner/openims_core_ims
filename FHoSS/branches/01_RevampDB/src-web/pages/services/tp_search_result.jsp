...
<table>
<tr>
	<td><br/><br/><h1>Trigger Point - Search Results </h1><br/><br/></td>
</tr>
</table>
</center>
...
<center>
	<table class="as" width="500">
		<logic:notEmpty name="resultList">
			...
			<logic:iterate name="resultList" id="tp"
				type="de.fhg.fokus.hss.db.model.TP" indexId="ix">
				<tr class="<%= ix.intValue()%2 == 0 ? "even" : "odd" %>">
					<td>
						<bean:write name="tp" property="id" />
					</td>
					<td> 
						<a href="/hss.web.console/TP_Load.do?id=<bean:write name="tp" property="id" />"> 
							<bean:write name="tp" property="name" />
						</a>	
					</td>

					<td> 
						<bean:write name="tp" property="condition_type_cnf" />
					</td>
