...
<center>
	<table class="as" width="500">
		<logic:notEmpty name="resultList">
			...
			<logic:iterate name="resultList" id="sp"
				type="de.fhg.fokus.hss.db.model.SP" indexId="ix">
				<tr class="<%= ix.intValue()%2 == 0 ? "even" : "odd" %>">
					<td>
						<bean:write name="sp" property="id" />
					</td>
					<td> 
						<a href="/hss.web.console/SP_Load.do?id=<bean:write name="sp" property="id" />"> 
							<bean:write name="sp" property="name" />
						</a>	
					</td>
				...
				<html:form action="/SP_Search">
					<table>
						<tr>
							...
							<html:select property="rowsPerPage" onchange="javascript:document.SP_SearchForm.submit();">
