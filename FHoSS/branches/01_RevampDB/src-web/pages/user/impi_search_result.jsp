...
<table>
<tr>
	<td><br/><br/><h1>Private User Identity - Search Results </h1><br/><br/></td>
</tr>
</table>
</center>
...
<center>
	<table class="as" width="500">
		<logic:notEmpty name="resultList">
			...
			<logic:iterate name="resultList" id="impi"
				...
				<tr class="<%= ix.intValue()%2 == 0 ? "even" : "odd" %>">
					...
					<td>
						<form method="post" action="/hss.web.console/IMPI_Delete.do" target="content" style="text-align: center">
							<input type="hidden" name="id" value="<bean:write name="impi" property="id" />"> 
