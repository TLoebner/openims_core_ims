...
<%@ taglib uri="http://jakarta.apache.org/struts/tags-logic"
	prefix="logic"%>
<%@ page import="java.util.*, de.fhg.fokus.hss.db.model.*, de.fhg.fokus.hss.web.util.*, de.fhg.fokus.hss.util.SecurityPermissions" %>
...
<body>
	<center><h1><br/><br/> Trigger Point - Search Results </h1></center>
